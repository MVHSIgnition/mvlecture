...
ffmpeg -y -f dshow -video_size 1920x1080 -framerate 30 -i video="USB Camera":audio="Microphone (Realtek High Definition Audio)" -i ./img/ignition_small.png -filter_complex "[0:v]transpose=2,transpose=2[v0_upsidedown];[v0_upsidedown][1:v]overlay=W-w:H-h[vid]" -map [vid] -map 0:a -copyts -c:v libx264 -preset veryfast -maxrate 1984k -bufsize 3968k -g 60 -c:a aac -b:a 128k -ar 44100 output.mp4
